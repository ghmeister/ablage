...
3. **Analyze** → AI Renamer sends content to OpenAI GPT-4o
4. **Generate** → OpenAI generates intelligent filename
...
ONEDRIVE_FOLDER_PATH=/path/to/folder
MAX_FILENAME_LENGTH=100
AI_NAMING_PROMPT=Custom AI prompt (optional)
```
