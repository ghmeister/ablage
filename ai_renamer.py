...
class AIRenamer:
    ...
    def analyze_document(self, pdf_content: str, original_filename: str, email_context: dict | None = None) -> dict:
        ...
        system_prompt = (
            ...
            "                    Spendenbescheinigung / donation certificate\n"
            ...
            "                    Dienstleistungsvertrag, any multi-page agreement with signatures\n"
            "  warranty        — Garantieschein, warranty certificate, Garantiebestätigung\n"
            ...
            "  - An Accenture payslip or employment confirmation → tax (Lohnausweis) or certificate\n"
